...
declare created_package_id uuid; allocation_id uuid; a public.order_serial_allocations%rowtype; entry jsonb; item public.sales_order_items%rowtype; qty numeric; begin
