-- Make customer checkout variation-aware. The selected variation is validated
-- against its parent and supplies the stock policy, price, SKU and order snapshot.
