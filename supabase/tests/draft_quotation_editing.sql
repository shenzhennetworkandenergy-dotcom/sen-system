...
begin
  ...
  select jsonb_build_object(
    ...
    'shipment_documents',pg_temp.dqe_table_fingerprint('public.shipment_documents'),
    'shipment_items',pg_temp.dqe_table_fingerprint('public.shipment_items'),
    'shipment_packages',pg_temp.dqe_table_fingerprint('public.shipment_packages'),
    'shipment_route_points',pg_temp.dqe_table_fingerprint('public.shipment_route_points'),
    ...
    'order_packages',pg_temp.dqe_table_fingerprint('public.order_packages'),
    'order_packed_items',pg_temp.dqe_table_fingerprint('public.order_packed_items'),
    'order_serial_allocations',pg_temp.dqe_table_fingerprint('public.order_serial_allocations'),
    'order_status_events',pg_temp.dqe_table_fingerprint('public.order_status_events'),
    'serial_numbers',pg_temp.dqe_table_fingerprint('public.serial_numbers'),
    'serial_number_history',pg_temp.dqe_table_fingerprint('public.serial_number_history'),
    'serial_tracking_events',pg_temp.dqe_table_fingerprint('public.serial_tracking_events'),
    'inventory_daily_closing_sheets',pg_temp.dqe_table_fingerprint('public.inventory_daily_closing_sheets'),
    'inventory_daily_closing_lines',pg_temp.dqe_table_fingerprint('public.inventory_daily_closing_lines'),
    'inventory_daily_closing_movement_details',pg_temp.dqe_table_fingerprint('public.inventory_daily_closing_movement_details'),
    'accounting_accounts',pg_temp.dqe_table_fingerprint('public.accounting_accounts'),
    ...
    'cashbook_descriptions',pg_temp.dqe_table_fingerprint('public.cashbook_descriptions'),
