...
export const siteConfig = {
  ...
  businessCategories: [
    ...
    { slug: "medical-equipment", label: "Medical Equipment", href: "/products#medical", accent: "teal", description: "Healthcare and laboratory technologies supported through structured sourcing and quotation workflows.", examples: ["Diagnostic equipment", "Hospital technology", "Laboratory systems", "Patient monitoring", "Healthcare solutions"] },
    { slug: "others", label: "Energy, Electrical & Electronics", href: "/products#energy", accent: "slate", description: "Specialized industrial, electrical, electronics and energy equipment procurement for custom requirements.", examples: ["Industrial automation", "Electronics", "Custom sourcing", "Project equipment", "Specialized procurement"] },
  ],
  solutionAreas: [
  ...
  footerGroups: [
    ...
    { title: "Products", links: [{ label: "Networking", href: "/products#networking" }, { label: "Energy", href: "/products#energy" }, { label: "Medical Equipment", href: "/products#medical" }, { label: "Energy & Electronics", href: "/products#energy" }] },
    ...
    { title: "Support", links: [{ label: "Request a Quote", href: routes.requestQuote }, { label: "Environment Check", href: routes.environmentCheck }] },
