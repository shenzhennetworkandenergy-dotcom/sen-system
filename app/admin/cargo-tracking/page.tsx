...
import { canEditCargoTrackingNumber, cargoLabel, getCargoJobs, getCargoRates, getCargoSearchSuggestions } from "@/lib/cargo-tracking/data";
...
export default async function CargoTrackingPage({ searchParams }: { searchParams: Promise<{ tracking?: string; customer?: string; cargoId?: string; success?: string; error?: string }> }) {
  ...
  const canEditTracking = canCreate;
