...
export default async function WorkLocationsPage({ searchParams }: { searchParams: Promise<{ success?: string; error?: string }> }) {
  ...
  const canManage = profile.role === "admin" || permissions.has("locations.manage");
