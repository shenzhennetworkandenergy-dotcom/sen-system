...
export default async function AttendancePage({ searchParams }: { searchParams: Promise<{ date?: string; success?: string; error?: string }> }) {
  ...
  const [data, employees] = await Promise.all([getHrAttendance(date), getHrEmployeeOptions()]);
