...
export default async function NewEmployeePage({ searchParams }: { searchParams: Promise<{ success?: string; error?: string }> }) {
  await connection();
  ...
  return <HrPage title="Add employee" subtitle="Connect an existing employee account to a complete HR record." success={params.success} error={params.error}><EmployeeForm refs={{...refs,profiles:available}}/></HrPage>;
}
