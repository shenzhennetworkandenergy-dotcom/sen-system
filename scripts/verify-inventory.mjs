...
for (const planned of ["Quotations", "Manufacturing", "Projects", "Support", "Reports", "AI Assistant", "Settings"]) assert.ok(navigation.includes(`label:"${planned}",route:null`), `Planned item ${planned} needs a disabled route`);
assert.ok(navigation.includes('label:"Sales",route:routes.adminSales'), "Implemented Sales needs its real route");
assert.ok(navigation.includes('label:"Purchasing",route:routes.adminPurchasing'), "Implemented Purchasing needs its real route");
assert.ok(navigation.includes('label:"Suppliers",route:routes.adminSuppliers'), "Implemented Suppliers needs its real route");
assert.ok(navigation.includes('label:"CRM",route:routes.adminCrm'), "Implemented CRM needs its real route");
assert.ok(navigation.includes('label:"Accounting",route:routes.adminAccounting'), "Implemented Accounting needs its real route");
