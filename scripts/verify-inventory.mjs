...
for (const planned of ["CRM", "Quotations", "Accounting", "HR", "Manufacturing", "Projects", "Support", "Reports", "AI Assistant", "Settings"]) assert.ok(navigation.includes(`label:"${planned}",route:null`), `Planned item ${planned} needs a disabled route`);
