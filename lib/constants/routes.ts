export const routes = {
  ...
  adminReceivableReports: "/admin/receivables/reports",
  adminReceivableCustomerReports: "/admin/receivables/reports/customers",
  adminReceivableNonSalesReports: "/admin/receivables/reports/non-sales",
  adminReceivableInstallmentReports: "/admin/receivables/reports/installments",
  adminReceivableActivityReports: "/admin/receivables/reports/activity",
  adminHr: "/admin/hr",
  ...
  adminInventoryDailyClosing: "/admin/inventory/daily-closing",
