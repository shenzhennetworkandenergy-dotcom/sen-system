...
export const adminNavigation: DashboardNavigationItem[] = [
  ...
  {key:"cargo-tracking",label:"Cargo Tracking",route:"/admin/cargo-tracking",group:"Inventory and Logistics",iconKey:"shipments",requiredPermission:null,implemented:true,adminVisible:true,employeeVisible:false},
