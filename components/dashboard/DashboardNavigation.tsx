...
export function DashboardNavigation({items,workCounts={},workCountsEndpoint}:DashboardNavigationProps){
  ...
  const displayedWorkCounts=workCountsEndpoint?liveWorkCounts:workCounts;
