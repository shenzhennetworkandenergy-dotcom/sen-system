...
export function MobileNavigation({
  ...
  return (
    <details className="sen-mobile-nav lg:hidden">
      ...
      <div className="absolute right-4 mt-3 grid w-64 gap-1 rounded-2xl border border-white/15 bg-[#090d2b]/95 p-4 text-sm font-semibold text-white shadow-2xl backdrop-blur-xl">
        {isAuthenticated ? (
          <>
