...
export const capabilities = ["Dynamic business categories", "China sourcing network", "Bangladesh operations", "Corporate quotation support", "Technical product categories", "International delivery coordination"] as const;
